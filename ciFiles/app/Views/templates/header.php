...
<html lang="en">
  <head>
    ...
    <title><?php echo $title ?> | 88ZwBackend</title>
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="<?php echo site_url(); ?>">88ZeroWaste</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link sidebar-link" href="<?php echo site_url('payment-page-settings'); ?>">
                Payment Page 
                </a>
            </li> -->
            <li class="nav-item">
